...
SECRET_KEY = 'django-insecure-m_nctjk-12r@!4h=s^2*r_4mws&#%n(my-)baq!lioswp0@mdm'
...
# Set urls for django to use by default
...
SOCIAL_AUTH_PIPELINE = [
    ...
    'account.authentication.create_profile', #Create user profile for social auth
    'social_core.pipeline.social_auth.associate_user',
    'social_core.pipeline.social_auth.load_extra_data',
    'social_core.pipeline.user.user_details',
]

# setting for bookmarklet
if DEBUG:
    import mimetypes
